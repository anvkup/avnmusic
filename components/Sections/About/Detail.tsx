...
const Detail = ({ onOpen }: ISkillSetModal) => {
  ...
  return (
    ...
    >
      ...
      <b>Abhinav</b> is a skilled and <b>creative music producer</b> with a passion for blending music and sound to create impactful auditory landscapes for more than {professionalYears} years.<br/> {' '}
      get your
     <Tooltip
        ...
        >
          <Text as="span" variant="emphasis">
            <b> hip-hop / originals /covers</b>
          </Text>
        </Tooltip>{' '} produced professionally.
        <br /> <br />
        Here are few things that are cup of my{' '}
        <Tooltip
